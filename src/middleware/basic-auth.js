...
export default (req, res, next) => {
  ...
  if(!encoded) {
    util.securityWarning('Clientside validation bypassed', 'Basic authorization header has been tampered with', authorization, 'basicAuth', requestInfo)
  ...
  if(!username || !password) {
    util.securityWarning('Clientside validation bypassed', 'Username or password was missing from login request', decoded, 'basicAuth', requestInfo)
